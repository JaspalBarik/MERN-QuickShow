...
const HeroSection = () => {
    ...
    return(
        ...
        <p className="max-w-md text-gray-300 ">🎬 QuickShow is where cinema comes alive — discover trending movies, watch trailers, and book tickets effortlessly, all in one seamless experience.</p>
